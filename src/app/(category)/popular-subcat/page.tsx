...
const Categories = () => {
  ...
  return (
    <main className="grid-container-desktop w-full min-h-screen">
      <div className="col-start-2 col-end-3 grid grid-cols-[280px_1fr] pt-8 pb-9 gap-6 text-[0.875rem]">
        ...
        <div className="flex-1 ">
            <h2 className="text-[32px] font-semibold text-text_primary pb-4">ประเภทงานยอดนิยม</h2>
