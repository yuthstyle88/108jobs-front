...
export default function LoginPage() {
    ...
    const [formState, setFormState] = useState({
        usernameOrEmail: "test2u22212211",
        password: "MySecurePassword1232",
    });
    ...
    const handleSubmitTotp = async (totp: string) => {
        try {
        ...
        <div>
            ...
            <div
                ...
                {loginLanguageData?.labelFreelancerVerified}
                    ...
                    <div
                        className="flex flex-col gap-6 justify-center items-center py-[4rem] max-w-[500px] w-full h-full ">
                        <Image
                        ...
                        {currentView === "login" && (
                            ...
                            >
                                <LoginForm
                                    ...
                                    openTotpModal={() => setShowTotpModal(true)}
                                />
