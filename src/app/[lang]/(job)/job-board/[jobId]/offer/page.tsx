      ...
      <div className="max-w-[1280px] w-[88vw] mx-auto px-4 py-6">
        <div className="flex items-center gap-4 mb-6">
          <button onClick={() => route.back()}>
            <ArrowLeft className="w-[26px] h-[26px] text-textPrimary" />
          </button>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-[441px_1fr] gap-8">
          <div>
            <h1 className="text-[32px] text-textPrimary font-bold">
              ...
              >
                <div>
                  ...
                  <textarea
                    ...
                    className="text-textPrimary w-full min-h-[120px] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="text-textPrimary w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  {errors.portfolioUrl && (
                ...
                <div>
                  ...
                  <label htmlFor="portfolio-files">
                    <Button variant="outline" type="button" className="w-full text-textPrimary">
                      <Paperclip className="w-4 h-4 mr-2 text-textPrimary" />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="0"
                        className="text-textPrimary w-full px-3 py-2 pr-12 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                ...
                <div className="flex justify-end gap-3 pt-4 text-textPrimary">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => route.back()}
