...
const MyJobEdit = ({jobId}: Props) => {
  ...
  const onSubmit = useCallback(async(data: any) => {
      try {
        ...
        successMessage(null,
          null,
          notificationLanguage?.editSuccess);
      } catch (error) {
        errorMessage(null,
          null,
          "Edit failed!");
    ...
    [editJob, jobId, successMessage, errorMessage, notificationLanguage]);
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    {id: "freelance", value: JobType.Freelance, label: t("createJob.employmentTypeFreelance")},
                    {id: "contract", value: JobType.Contract, label: t("createJob.employmentTypeContract")},
                    {id: "parttime", value: JobType.PartTime, label: t("createJob.employmentTypePartTime")},
                    {id: "fulltime", value: JobType.FullTime, label: t("createJob.employmentTypeFullTime")},
                  ].map((option) => (
                    <div
                      key={option.id}
                  ...
                  {[
                    {
                      ...
                      label: t("createJob.intendedUseBusiness"),
                    },
                    {
                      ...
                      label: t("createJob.intendedUsePersonal"),
                    },
                    {
                      ...
                      label: t("createJob.intendedUseUnknown"),
                    },
                  ].map((option) => (
                    <div
                      key={option.value}
