  ...
  return (
    <div className="p-4 md:p-0">
      <div className="my-service-gradient rounded-lg shadow-sm p-6 mb-8 flex justify-between items-center hover:shadow-job-card duration-300">
        <div className="flex-1">
          ...
          <Link prefetch={false} href="/content/commission">
            <button className="mt-4 bg-primary text-white text-sm font-medium py-2 px-4 rounded">
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <Link prefetch={false} href="/manage-product/create">
          <button
            ...
            className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium disabled:bg-blue-300 disabled:cursor-not-allowed"
          >
        ...
        <div className="bg-orange-100 border border-blue-100 rounded-lg p-4 mb-4 flex items-start">
          ...
          <div className="text-sm">
            <span className="text-gray-700">
              You are currently pending approval by {getAppName()}. You will be able
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-6 flex items-start">
        <ClockAlert className="w-5 h-5 text-primary mr-3 mt-0.5 flex-shrink-0"/>
        <div className="text-sm">
          <span className="text-gray-700">
          ...
          {isLoading ? (
            ...
            jobsData.jobs.map((job) => (
              ...
              >
                ...
                <div className="inline-block bg-blue-100 text-primary text-xs font-medium px-2 py-1 rounded">
