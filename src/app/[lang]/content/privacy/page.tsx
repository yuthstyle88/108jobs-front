          ...
          <div className="col-start-2 col-end-3 flex flex-row items-start gap-6 p-4 md:p-0">
            <ol className="text-text-primary pt-3 list-decimal grid gap-2 mb-2 font-sans">
              ...
              <ul className="list-disc pl-[48px] grid gap-2">
                ...
                <li>
                  <strong>“108jobs”</strong> หมายความว่า แอปพลิเคชั่นของบริษัทฯ
              ...
              <p className="mb-6 m-0 leading-[1.5]">
                ...
                108jobs ของท่านโดยตรงหรือจากช่องทางอื่นดังต่อไปนี้
              </p>
              <ul className="list-disc pl-[48px] grid gap-2">
              ...
              <p className="mb-6 m-0 leading-[1.5]">
                ...
                จากช่องทางสนทนาหรือประกาศต่าง ๆ ของ 108jobs ทั้งนี้
                ท่านรับรองว่าการเปิดเผยหรือส่งข้อมูลส่วนบุคคลของบุคคลอื่นใน
                108jobs นั้นเป็นไปโดยชอบด้วยกฎหมาย ซึ่งรวมถึงแต่ไม่จำกัดเพียง
              ...
              <ul className="list-disc pl-[48px] grid gap-2">
                ...
                <li>
                  ...
                  อาทิ เพื่อสร้างและจัดการบัญชีผู้ใช้งาน 108jobs เป็นต้น
                </li>
                <li>
              ...
              <ul className="list-disc pl-[48px] grid gap-2">
                ...
                <li>
                  ข้อมูลบัญชี 108jobs ได้แก่ บัญชีผู้ใช้งาน
              ...
              <ul className="list-disc pl-[48px] grid gap-2">
                <li>เพื่อสร้างและจัดการบัญชีผู้ใช้งาน 108jobs</li>
                ...
                <li>
                  เพื่อควบคุมไม่ให้มีการใช้ 108jobs ที่ฝ่าฝืนข้อตกลงและเงื่อนไข
                  (Terms and Conditions) ของ 108jobs อาทิ
                  ควบคุมไม่ให้มีการแลกเปลี่ยนข้อมูลติดต่อระหว่างผู้รับจ้างและผู้ว่าจ้าง
                  เป็นต้น
                </li>
                <li>
                  เพื่อใช้สิทธิทางศาลหรือระงับข้อพิพาทใด ๆ
                  ที่อาจเกิดขึ้นจากการใช้บริการ 108jobs
                </li>
              ...
              <ul className="list-disc pl-[48px] grid gap-2">
                <li>
                  ...
                  อาทิ เพื่อทำวิจัยสถิติผู้เข้าใช้บริการ 108jobs ฯลฯ
                </li>
                <li>
                ...
                <li>
                  ...
                  อาทิ เพื่อสร้างและจัดการบัญชีผู้ใช้งาน 108jobs ฯลฯ
                </li>
                <li>
              ...
              <p className="mb-6 m-0 leading-[1.5]">
                <strong>
                  ...
                  108jobs ตามข้อตกลงและเงื่อนไข (Terms and Conditions)
                </strong>
              </p>
              <p className="mb-6 m-0 leading-[1.5]">
                บริษัทฯ
                ...
                108jobs ตามข้อตกลงและเงื่อนไข (Terms and Conditions)
                ซึ่งรวมถึงแต่ไม่จำกัดเพียง การควบคุมไม่ให้มีการใช้ 108jobs
                ที่ฝ่าฝืนข้อตกลงและเงื่อนไข (Terms and Conditions) ของ 108jobs
                ผ่านการใช้งาน
                <br/>
                ...
                108jobs ในกรณีที่ท่านใช้สิทธิคัดค้านการประมวลผลข้อมูลส่วนบุคคล
                สิทธิขอให้ลบหรือทำลายข้อมูลส่วนบุคคล
                สิทธิระงับการใช้ข้อมูลส่วนบุคคล หรือสิทธิอื่นใด (ถ้ามี)
                ท่านอาจถูกจำกัดสิทธิในการเข้าถึงหรือเข้าใช้งาน 108jobs ได้
              </p>
              <p className="mb-6 m-0 leading-[1.5]">
                <strong>
              ...
              <p className="mb-6 m-0 leading-[1.5]">
                ...
                <br/>
                ในกรณีที่ท่านยกเลิกบัญชีผู้ใช้งานของ 108jobs บริษัทฯ
                จะเก็บรักษาข้อมูลส่วนบุคคลของท่านเท่าที่จำเป็นเพื่อให้บรรลุวัตถุประสงค์ที่กำหนดไว้ในนโยบายฯ
                หรือตามอำนาจแห่งกฎหมาย โดยท่านสามารถทำรายการผ่าน 108jobs (
                <Link prefetch={false}
              ...
              <ol>
                ...
                <li>
                  ...
                  <p className="mb-6 m-0 leading-[1.5]">
                    ท่านสามารถใช้สิทธิได้โดยการเข้าใช้งานบัญชีผ่านของ 108jobs (
                    <Link prefetch={false}
                          className="text-third underline"
                          href="/content/support-center"
                    >
              ...
              <table className="border-collapse border-spacing-[2px] border-gray-400 ">
                ...
                <tr>
                  ...
                  <td className="border-1 border-black text-center">
                    ดำเนินการด้วยตนเองบนเว็บไซต์ 108jobs
                  </td>
                  <td className="border-1 border-black text-center">
                    กรอกแบบคำขอใช้สิทธิ
                  </td>
              ...
              <p className="mb-6 m-0 leading-[1.5]">
                ...
                108jobs เท่านั้น ทั้งนี้ การใช้บริการ 108jobs
