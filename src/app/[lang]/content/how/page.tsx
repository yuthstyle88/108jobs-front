...
const EMPLOYERS = [
  ...
  },
  {
    ...
    list: [
      ...
      "You can make payment via "+getAppName()+" by the following methods:",
  ...
  },
  {
    ...
    list: [
      ...
      "Rate and review your satisfaction with "+getAppName()+" system to improve the service even further",
    ],
  },
];
...
const SELLERS = [
  {
    id: 1,
    title: "Post your work on "+getAppName()+" to present your ability to buyer",
        ...
        >
          <div className="px-[1.5rem] relative">
            <div className="text-center text-white">
              <h1 className="text-[28px]">How to buy/sell on {getAppName()}?</h1>
          ...
          <div className="col-start-2 col-end-3">
            <div className="text-center w-full">
              <h1 className="font-sans text-[1.5rem] text-text-primary font-semibold mb-12">
                Easy steps to get started with {getAppName()}
              </h1>
            </div>
          </div>
