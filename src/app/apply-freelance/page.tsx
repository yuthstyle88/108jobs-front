...
const FreelancerRegistration = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 7:
        return <StepSeven formData={formData} updateFormData={updateFormData} nextStep={nextStep} prevStep={prevStep} />;
      case 8:
        return <StepEight formData={formData} updateFormData={updateFormData} nextStep={nextStep} prevStep={prevStep} />;
      case 9:
        return <StepNine formData={formData} updateFormData={updateFormData} prevStep={prevStep} />;
      default:
        return <StepOne formData={formData} updateFormData={updateFormData} nextStep={nextStep} />;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="w-[80vw] h-full max-h-[calc(100%-6rem)] m-0 mx-auto mb-8 pt-8 px-4">
        ...
        <div className="bg-white rounded-lg shadow-jobCard">
          {renderStep()}
        </div>
      </div>
    </div>
