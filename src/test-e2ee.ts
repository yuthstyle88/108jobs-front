...
async function testKeyExchange() {
  ...
  console.log('Client public key (hex):',
    clientPublicKeyHex);
  ...
  console.log('Server public key (hex):',
    serverPublicKeyHex);
  ...
  console.log('Client shared secret (hex):',
    clientSharedSecretHex);
  ...
  console.log('Server shared secret (hex):',
    serverSharedSecretHex);
