...
export const vi = {
    ...
    translation: {
        ...
        profileChat: {
            ...
            step2Sub: "Nhà tuyển dụng duyệt báo giá, tạo đơn hàng, sẵn sàng thanh toán",
            step3: "Đang thực hiện",
            step3Sub: "Đã thanh toán, tiền giữ hộ, chờ gửi sản phẩm",
            step4: "Chờ nhà tuyển dụng duyệt",
            step4Sub: "Đã gửi sản phẩm; chờ nhà tuyển dụng xem xét trước khi giải ngân",
            step5: "Hoàn thành",
            step5Sub: "Nhà tuyển dụng đã duyệt, giải ngân cho freelancer",
            step6: "Đã hủy",
