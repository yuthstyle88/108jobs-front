export const vi = {
    ...
    translation: {
        ...
        profileChat: {
            ...
            step1: 'Đang chờ duyệt báo giá',
            step1Sub: 'Báo giá được tạo bởi freelancer, đang chờ nhà tuyển dụng xem xét',
            step2: 'Đơn hàng đã được duyệt',
            step2Sub: 'Nhà tuyển dụng đã duyệt báo giá, trở thành đơn hàng, sẵn sàng thanh toán',
            step3: 'Đang thực hiện',
            step3Sub: 'Nhà tuyển dụng đã thanh toán, tiền ký quỹ, chờ gửi sản phẩm',
            step4: 'Chờ nhà tuyển dụng duyệt',
            step4Sub: 'Đã gửi sản phẩm; chờ nhà tuyển dụng duyệt trước khi thanh toán',
            step5: 'Hoàn thành',
            step5Sub: 'Nhà tuyển dụng đã duyệt sản phẩm, thanh toán cho freelancer',
            step6: 'Đã hủy',
            step6Sub: 'Hủy báo giá/đơn hàng trước khi thanh toán',
            proposeQuote: 'Đề xuất báo giá',
            sendBriefMessage: 'Gửi tin nhắn tóm tắt',
            uploadReference: 'Tải lên tệp tham khảo',
            acceptJob: 'Chấp nhận công việc',
            askDetails: 'Hỏi chi tiết',
            startChat: 'Bắt đầu thảo luận công việc',
            uploadDraft: 'Tải lên tệp nháp',
            uploadFileLink: 'Tải lên tệp/Liên kết',
            ...
            cancelJobMsg: "Công việc đã bị hủy.",
            reviewDeliveryTitle: "Xem xét sản phẩm bàn giao",
            reviewDeliveryDesc: "Freelancer đã gửi sản phẩm. Bạn muốn chấp nhận hay yêu cầu chỉnh sửa?",
            acceptAndRelease: "Chấp nhận & Thanh toán",
            quotationError: "Không thể tạo hóa đơn. Vui lòng thử lại.",
