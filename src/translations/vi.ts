export const vi = {
    ...
    translation: {
        ...
        profileChat: {
            ...
            step1: 'Khách hàng liên hệ',
            step1Sub: 'Bắt đầu trò chuyện / Mẫu thông tin',
            step2: 'Trong hàng đợi',
            step2Sub: 'Chờ phân công / Báo giá',
            step3: 'Được phân công',
            step3Sub: 'Hệ thống/Quản trị viên chọn freelancer',
            step4: 'Freelancer nhận công việc',
            step4Sub: 'Chấp nhận hoặc từ chối công việc',
            step5: 'Thảo luận công việc',
            step5Sub: 'Trò chuyện và chia sẻ tệp',
            step6: 'Gửi & Đánh giá',
            step6Sub: 'Tải lên sản phẩm hoàn chỉnh',
            step7: 'Thanh toán',
            step7Sub: 'Ký quỹ đến thanh toán',
