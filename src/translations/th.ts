export const th = {
    ...
    translation: {
        ...
        authen: {
            ...
            verificationMessage:
                "108Jobs จะทำการส่งรหัสยืนยันไปยัง อีเมล/เบอร์โทรศัพท์ของคุณ เพื่อยืนยันความเป็นเจ้าของบัญชี",
            ...
            titleSignInCreateAccount: "เข้าสู่ระบบ 108jobs",
        ...
        categoryFooter: {
            ...
            seoDescription2Part1:
                "คุณภาพ ช่วยให้เว็บไซต์ของคุณแสดงเป็นอันดับต้น ๆ บน Google ทำให้เว็บไซต์ของคุณมีโอกาสที่คนเข้าชมสูงขึ้นและเป็นที่รู้จักมากขึ้น ที่ 108jobs.com เรามีฟรีแลนซ์ให้บริการ SEO ผู้เชี่ยวชาญที่มีประสบการณ์ในการ ",
            ...
            seoConclusionPart1:
                "รายละเอียดของการทำ SEO ไม่ได้มีตายตัว และเปลี่ยนแปลงบ่อย เพราะฉะนั้นต้องติดตามและคอยอัพเดตหลักการทำ SEO อยู่เสมอ ๆ หรือหากยังไม่มีประสบการณ์ ความรู้ ความชำนาญ สามารถจ้างฟรีแลนซ์ผู้เชี่ยวชาญรับทำ SEO ช่วยในการเริ่มต้น ให้คุณสำเร็จได้ง่ายกว่า 108jobs.com ได้รวบรวม Freelance รับทำ SEO มืออาชีพด้วย ",
            ...
            howToHireTitle: "วิธีจ้างฟรีแลนซ์ ทำ SEO บน 108Jobs",
            howToHireSteps0:
            ...
            howToHireSteps2:
                "ชำระเงินผ่าน 108jobs โดยชำระได้ 3 ช่องทางทั้ง บัตรเครดิต, โมบายแบงค์กิ้ง และจ่ายด้วย 108jobs coin มั่นใจได้แน่นอนด้วย 108jobs การันตี",
            howToHireSteps3:
        ...
        commission: {
            ...
            subheader: "ค่าบริการ 108Jobs ตามระดับ",
            ...
            allContentWhatIsFeeUsedFor: "ค่าบริการ 108Jobs ใช้เพื่ออะไร?",
            whatIsAccumulatedIncomeFeeTitle: "ค่าบริการตามรายได้สะสมคืออะไร?",
            whatIsAccumulatedIncomeFeeDescription:
                "นี่คือค่าบริการที่ประกาศล่วงหน้าตามยอดรวมแต่ละครั้งสำหรับฟรีแลนเซอร์ โดยคำนวณตามระดับสมาชิก 108Jobs ระดับสมาชิกจะถูกกำหนดตามรายได้สะสมในช่วง 3 เดือนที่ผ่านมา ถึงวันที่สร้างรายงานโครงการและเสร็จสมบูรณ์",
            ...
            fastlaneFeePurposeQuest: "ค่าบริการ 108Jobs ใช้เพื่ออะไร?",
            fastlaneFeePurpose:
        ...
        employeeRegister: {
            ...
            fastworkUsageTip:
                "การใช้ 108Jobs อย่างถูกต้องช่วยลดความเสี่ยงในการถูกระงับบัญชี",
            complianceTip:
        ...
        global: {
            ...
            adsSectionDescription: "เพิ่มโอกาสในการถูกจ้างโดยการโฆษณากับ 108Jobs",
            bankInfo: "ข้อมูลธนาคาร",
            businessServiceDescription:
                "บริการจัดหาฟรีแลนซ์เพื่อธุรกิจ (108Jobs for Business)",
            ...
            buttonSubmit: "บันทึก",
            buttonVerify: "ยืนยัน",
            chatToHireButton: "แอดไลน์ @108jobs",
            ...
            fastworkRewardsButton: "รางวัล 108Jobs",
            ...
            goToFastworkBusiness: "ไปยัง 108Jobs for Business",
            ...
            labelAboutFastworkTitle: "เกี่ยวกับ 108Jobs",
            ...
            labelMenuOption22: "บริการฟรีแลนซ์สำหรับธุรกิจ (108Jobs for Business)",
            ...
            labelWorkWithFastwork: "ร่วมงานกับ 108Jobs",
            ...
            sidebarFastworkRewards: "รางวัล 108Jobs",
            ...
            tittleFooter4: "เกี่ยวกับ 108Jobs",
        ...
        guarantee: {
            ...
            fastworkGuaranteeSubtitle:
                "จ้างฟรีแลนซ์ผ่านแพลตฟอร์ม 108Jobs ได้รับการคุ้มครองอย่างครอบคลุมในทุกขั้นตอน",
            fastworkGuaranteeSubsubtitle:
                "ตั้งแต่เริ่มต้นจนถึงส่งมอบงานที่มีคุณภาพตามที่ต้องการ",
            fastworkGuaranteeStepsTitle:
                "108Jobs Guarantee ปกป้องทุกขั้นตอนในกระบวนการจ้างงาน",
            ...
            termsConditionsTitle:
                "ข้อกำหนดและเงื่อนไขของโปรแกรม 108Jobs Guarantee มั่นใจมากขึ้นในการจ้างงาน",
            ...
            protectionCase4:
                "ผลงานสุดท้ายยังไม่ได้รับการอนุมัติด้วยตนเองหรืออัตโนมัติบนแพลตฟอร์ม 108Jobs",
            endProtectionTitle: "สิ้นสุดการคุ้มครอง",
            endProtectionCase1: "ลูกค้าละเมิดสัญญาการจ้างงานที่ระบุในใบเสนอราคา",
            endProtectionCase2:
                "ลูกค้าไม่ได้ทำการจ้างงานและชำระเงินผ่านแพลตฟอร์ม 108Jobs",
            endProtectionCase3:
                "ผลงานสุดท้ายได้รับการอนุมัติด้วยตนเองหรืออัตโนมัติบนแพลตฟอร์ม 108Jobs",
            ...
            confidentHiringTitle:
                "มั่นใจในการจ้างงานกับ 108Jobs คุณมีอิสระในการเลือกที่จะยอมรับผลงานสุดท้ายหรือขอคืนเงิน",
            ...
            step3Description:
                "แจ้งความคาดหวังของคุณเกี่ยวกับผลงานและคุณภาพบริการของฟรีแลนซ์ ไม่มีใครสามารถเข้าถึงการรีวิวแบบไม่เปิดเผยตัวตนนี้ได้ ยกเว้นบุคลากรหลักของ 108Jobs สิ่งนี้สำคัญอย่างยิ่งที่เราจะนำไปปรับปรุงคุณภาพฟรีแลนซ์ของเราเพื่อให้บริการคุณได้อย่างพึงพอใจที่สุด",
            step4Title: "4. ให้คะแนนความประสงค์ในการแนะนำ 108Jobs ให้ผู้อื่น",
            step4Description:
                "คุณสามารถแบ่งปันปัญหาหรือความยากลำบากที่คุณพบเจอในระหว่างการใช้แพลตฟอร์ม นอกจากนี้ คุณยังสามารถให้ความคิดเห็นและข้อเสนอแนะแก่ทีม 108Jobs ข้อเสนอแนะทั้งหมดของคุณจะได้รับการพิจารณาอย่างจริงจังเพื่อปรับปรุงคุณภาพบริการของเรา",
        ...
        home: {
            ...
            contentFastwork1:
                "108Jobs เป็นแพลตฟอร์มที่รวบรวมฟรีแลนซ์มืออาชีพจากหลากหลายสาขา ไม่ว่าจะเป็นการออกแบบโลโก้ ทำแบนเนอร์โฆษณา เขียนบทความ แปลภาษา การตลาดออนไลน์ พัฒนาเว็บไซต์ และงานอื่นๆ อีกกว่า 90 หมวดหมู่ เพื่อตอบสนองความต้องการที่หลากหลายของทั้งธุรกิจและผู้ใช้งาน ทีมงานของเราพัฒนา 108Jobs โดยเน้นความเรียบง่าย และสะดวกต่อการใช้งาน เพื่อช่วยประหยัดเวลาให้กับฟรีแลนซ์และลูกค้า อีกทั้งยังสนับสนุนการสร้างและขยายธุรกิจ รวมถึงช่วยให้ฟรีแลนซ์หางานได้ง่ายขึ้น มีรายได้เพิ่มขึ้น และมีคุณภาพชีวิตที่ดีขึ้น.",
            contentFastwork2:
                "108Jobs ทำหน้าที่เป็นสื่อกลางระหว่างฟรีแลนซ์และลูกค้า ทำให้ทั้งสองฝ่ายสามารถเชื่อมต่อกันได้ทุกที่ทุกเวลา ฟรีแลนซ์สามารถลงประกาศรับจ้างงานได้ ส่วนลูกค้าก็สามารถค้นหาฟรีแลนซ์ที่ต้องการได้ในที่เดียวกัน ระบบการชำระเงินที่ปลอดภัยของ 108Jobs ช่วยรับประกันว่า ฟรีแลนซ์จะได้รับค่าจ้างเมื่อทำงานสำเร็จ และลูกค้าจะได้รับงานที่ตรงตามข้อตกลง.",
            contentFastwork3:
                "ปัจจุบัน 108Jobs มีฟรีแลนซ์ที่ผ่านการคัดกรองคุณภาพแล้วกว่า 50,000 คน ให้บริการในหมวดหมู่ที่ครอบคลุมกว่า 90 หมวดหมู่ มีงานให้เลือกมากกว่า 15,000 รายการ รองรับทุกกลุ่มลูกค้า ไม่ว่าจะเป็นเจ้าของกิจการ ธุรกิจ SME พ่อค้าแม่ค้าออนไลน์ หรือบุคคลทั่วไปที่ต้องการบริการระดับมืออาชีพในราคาที่เข้าถึงได้ 108Jobs เป็นแพลตฟอร์มฟรีแลนซ์มืออาชีพที่ได้รับความไว้วางใจจากลูกค้ากว่า 700,000 ราย.",
            contentFreelancerVerification:
                "ฟรีแลนซ์ผ่านการคัดเลือก และยืนยันตัวตน กับ 108Jobs สามารถตรวจสอบได้",
            ...
            contentQualityOfferFreelancerCard2:
                "ผ่านการตรวจสอบผลงาน ตามมาตรฐานขั้นต้นของ 108Jobs",
            contentQualityOfferProfessionalCard1: "ผ่านการยืนยันตัวตนในระบบ",
            contentQualityOfferProfessionalCard2:
                "ผ่านการคัดเลือก ทดสอบความรู้ตามสายงาน และทักษะในการทำงานโดย 108Jobs",
            contentQualityOfferProfessionalCard3:
                "ผ่านการอบรมพิเศษด้านทักษะและการให้บริการจาก 108Jobs",
            ...
            contentQualityOfferSpecialistCard4:
                "มีใบประกอบวิชาชีพที่จำเป็นตามสายงาน 108Jobs",
            ...
            labelStartHiringSection3: "3. ชำระเงินผ่าน 108Jobs",
            ...
            platformDescription:
                "108jobs.com คือเว็บไซต์ที่รวบรวม ฟรีแลนซ์ มืออาชีพจากหลากหลายสายงานไว้ในที่เดียวกัน ไม่ว่าจะเป็น งานออกแบบกราฟิก ทำแบนเนอร์โฆษณา เขียนบทความ แปลภาษา การตลาดออนไลน์ พัฒนาเว็บไซต์ และงานอื่นๆ อีกกว่า 90 หมวดหมู่ เพื่อตอบโจทย์ความต้องการที่หลากหลายของทั้งผู้ประกอบการและผู้ใช้งานทั่วไป ทีมพัฒนาของเราได้ออกแบบ 108jobs.com ให้เรียบง่ายและสะดวกในการใช้งาน เพื่อให้เป็นแพลตฟอร์มที่ช่วยประหยัดเวลาให้กับทั้ง ฟรีแลนซ์ และลูกค้า อีกทั้งยังช่วยสนับสนุนการสร้างธุรกิจใหม่ ๆ ให้กับผู้ประกอบการและยกระดับมาตรฐานของฟรีแลนซ์ไทยให้ดียิ่งขึ้น",
            platformPurpose:
                "108jobs.com ทำหน้าที่เป็นสื่อกลางออนไลน์ระหว่าง ฟรีแลนซ์ และผู้ว่าจ้าง ให้สามารถพบกันและทำงานร่วมกันได้ทุกที่ทุกเวลา โดยที่ ฟรีแลนซ์ สามารถใช้เว็บไซต์ 108jobs.com ในการลงประกาศรับงานได้อย่างสะดวกในที่เดียว อีกทั้งยังมีระบบการคัดกรองที่ช่วยให้ลูกค้าสามารถเปรียบเทียบราคาและคุณภาพของ ฟรีแลนซ์ ได้ง่ายขึ้น 108jobs.com ยังรับประกันการส่งมอบงานให้เสร็จสมบูรณ์ก่อนที่ฟรีแลนซ์จะได้รับเงิน เพื่อความมั่นใจของทั้งสองฝ่าย",
            subtitleBanner: "ขยายธุรกิจของคุณให้เติบโตด้วยฟรีแลนซ์ที่ใช่",
            subtitleDownloadApp:
                "ทำให้กระบวนการจ้างงานของคุณง่ายขึ้นด้วยแอป 108Jobs ค้นหา, บรีฟ, ชำระเงิน และรับงานได้อย่างราบรื่น—all in one app.",
            titleAstrologyFreelancers:
                "ฟรีแลนซ์ยอดนิยมในหมวดดูดวง โหราศาสตร์ ความเชื่อ",
            titleBanner: "108Jobs สำหรับธุรกิจ",
            titleBannerHomePage1: "เรามีฟรีแลนซ์มืออาชีพด้าน...",
            titleBannerHomePage2: "ที่พร้อมเปลี่ยนไอเดียของคุณให้เป็นความจริง",
            titleFeaturedWorks: "ผลงานแนะนำจากฟรีแลนซ์บน 108Jobs",
            titleJobCategories: "หมวดหมู่งานบน 108Jobs",
            ...
            titleStartHiringSection: "เริ่มจ้างงานฟรีแลนซ์ง่ายๆ กับ 108Jobs",
            titleTrustedCompanies:
                "กว่า 150,000 โปรเจกต์ที่สำเร็จ โดยบริษัทชั้นนำที่ไว้วางใจ 108Jobs",
            tittleFirstSlogan: "ฟรีแลนซ์คุณภาพอันดับ 1",
            tittlePrimaryWhySection: "ทำไมถึงต้องใช้ 108Jobs?",
            ...
            tittleThirdSlogan: "ครบทุกงานที่ต้องการ มั่นใจ เลือก 108Jobs",
        ...
        how: {
            howToBuySellTitle: "วิธีการซื้อขายบริการบน 108Jobs?",
            howToBuySellSubtitle: "เว็บไซต์อันดับหนึ่งในตลาดฟรีแลนซ์",
            easyStepsTitle: "เริ่มต้น 108Jobs ด้วยขั้นตอนง่ายๆ",
            ...
            employerStep3List2: "คุณสามารถชำระเงินผ่าน 108Jobs ด้วยวิธีต่อไปนี้:",
            ...
            employerStep5Description: "เพื่อพัฒนาสังคม 108Jobs",
            employerStep5List1:
                "ให้คะแนนและรีวิวลูกค้าเพื่อประโยชน์ของฟรีแลนซ์คนอื่นๆ",
            employerStep5List2:
                "แสดงความคิดเห็นเกี่ยวกับความพึงพอใจของคุณต่อระบบ 108Jobs เพื่อช่วยปรับปรุงคุณภาพบริการ",
            sellerStep1Title:
                "ลงประกาศสินค้า/โปรเจกต์ของคุณบน 108Jobs เพื่อแสดงความสามารถพิเศษของคุณแก่ลูกค้าที่มีศักยภาพ",
        ...
        jobBoardCreate: {
            ...
            warning:
                "คำเตือน: การชักชวนลูกค้าให้ชำระเงินนอกระบบ 108Jobs เป็นการละเมิดข้อกำหนดการใช้งานและอาจนำไปสู่การระงับบัญชีได้",
        ...
        jobBoardDetail: {
            ...
            recommendation:
                "เราขอแนะนำให้คุณสื่อสารและชำระเงินผ่าน 108Jobs เพื่อป้องกันการฉ้อโกง! เราจะปกป้องการชำระเงินของคุณจนกว่าคุณจะได้รับผลงานจากฟรีแลนซ์",
            wantToFind:
        ...
        jobDetail: {
            ...
            marketingAdvertising: "การตลาดและโฆษณา",
            doSeo: "ทำ SEO",
            fastworkGuarantee: "การรับประกัน 108Jobs",
        ...
        manageProductCreate: {
            ...
            confirmationCheck3: "ฉันได้อ่านและยอมรับข้อกำหนดการใช้งานของ 108Jobs",
            ...
            confirmationWarning:
                "หากคุณไม่ยืนยันเงื่อนไข คุณจะไม่สามารถเผยแพร่บริการบน 108Jobs ได้",
            coverImageNote:
        ...
        profileApply: {
            ...
            privilegesDescription:
                "ยิ่งขายงานมาก ยิ่งได้สิทธิพิเศษจาก 108Jobs มากขึ้น",
            professional1: "ผู้เชี่ยวชาญหลายสาขาที่ผ่านการคัดเลือกจาก 108Jobs",
            professional2: "ใช้สิทธิ์ขอคำปรึกษาโดยตรงผู้เชี่ยวชาญ",
            professional3:
                "Badge ที่แสดงสำหรับ Professional ผู้เชี่ยวชาญ 108Jobs ช่วยให้คุณจ้างงานที่คุณได้อย่างมั่นใจ",
            professional4:
                "โอกาสในการได้รับงานมากยิ่งขึ้น จากลูกค้าองค์กรชั้นนำของ 108Jobs",
            ...
            sellStep4Desc:
                "มั่นใจทุกการจ้างงานผ่าน 108Jobs การันตีดูแลเงินคุณ หมดกังวลเรื่องผู้ว่าจ้างไม่ชำระเงิน ช่วยให้คุณทำงานได้อย่างสบายใจ",
            ...
            sellStep6DescPrefix: "108Jobs จะทำการโอนเงินเข้าบัญชีธนาคารของคุณตาม",
            sellStep6DescSuffix:
            ...
            sellStepsTitle: "6 ขั้นตอนง่ายๆ ขายงานบน 108Jobs",
            specialist1: "ผู้เชี่ยวชาญที่ผ่านการทดสอบความสามารถตามมาตรฐาน 108Jobs",
            specialist2: "ใช้สิทธิ์ขอคำปรึกษาโดยตรงกับทีมแอดฯ",
            specialist3: "โอกาสพิเศษรับงานจาก Partner ของเรา",
            specialist4:
                "Badge ที่แสดงว่าเป็น ผู้เชี่ยวชาญ ซึ่งบริการจาก 108Jobs ช่วยให้คุณจ้างงานที่คุณได้อย่างมั่นใจ",
            ...
            step4: "ทำงานได้อิสระ",
            step4Description:
                "มั่นใจได้ทุกงาน! 108Jobs ช่วยดูแลค่าจ้างของคุณ ไม่ต้องกังวลนายจ้างไม่จ่ายเงิน",
            step5: "ส่งงานและรีวิว",
            step5Description:
                "ส่งงานที่เสร็จแล้วให้นายจ้างตรวจสอบ ยิ่งงานดี ยิ่งเพิ่มความน่าเชื่อถือ",
            step6: "รับเงินและสิทธิพิเศษ",
            step6Description:
                "108Jobs โอนเงินเข้าบัญชีของคุณตามข้อตกลง ยิ่งขายมาก ยิ่งได้มาก",
            stepsTitle: "6 ขั้นตอนง่ายๆ ขายงานบน 108Jobs",
            ...
            whyChooseTitle: "ทำไมฟรีแลนซ์ถึงเลือก 108Jobs",
        ...
        profileChat: {
            ...
            you: "คุณ",
            download: "ดาวน์โหลด",
            cannotDown: "ไม่สามารถดาวน์โหลดได้",
            attach: "แนบไฟล์",
            price: "ราคา",
            checkboxUnhiredOnly: "แสดงเฉพาะช่องว่างที่ไม่ได้จ้าง",
            days: "วัน",
            guide: "คู่มือการใช้งาน",
            jobBranch: "สาขางาน",
            labelFilterJobs: "สาขางาน",
            labelNoConversation: "กรุณาเลือกออเดอร์ทางซ้ายมือเพื่อเริ่มสนทนา",
            searchPlaceholder: "ค้นหาจากอะไร",
            sectionChat: "สนทนา",
            securePaymentNote: "ปลอดภัยว่า เชื่อจ่ายเงินผ่าน 108Jobs",
            ...
            details: 'สถานะปัจจุบัน',
            step1: 'รอพิจารณาใบเสนอราคา',
            step1Sub: 'ฟรีแลนซ์สร้างใบเสนอราคาแล้ว กำลังรอนายจ้างตรวจสอบ',
            step2: 'อนุมัติคำสั่งซื้อ',
            step2Sub: 'นายจ้างอนุมัติใบเสนอราคา กลายเป็นออเดอร์ พร้อมชำระเงิน',
            step3: 'ระหว่างดำเนินงาน',
            step3Sub: 'นายจ้างชำระเงินแล้ว เงินอยู่ในระบบคุ้มครอง กำลังรอส่งงาน',
            step4: 'รอตรวจงาน',
            step4Sub: 'ฟรีแลนซ์ส่งงานแล้ว; รอนายจ้างตรวจสอบก่อนปล่อยเงิน',
            step5: 'เสร็จสิ้น',
            step5Sub: 'นายจ้างอนุมัติผลงาน ปล่อยเงินให้ฟรีแลนซ์',
            step6: 'ยกเลิก',
            step6Sub: 'ยกเลิกใบเสนอราคา/ออเดอร์ ก่อนชำระเงิน',
            proposeQuote: 'เสนอราคา',
            sendBriefMessage: 'ส่งข้อความหาไฟล์บรีฟ',
            uploadReference: 'แนบไฟล์อ้างอิง',
            acceptJob: 'กดรับงาน (Accept)',
            askDetails: 'ถามรายละเอียด',
            startChat: 'เริ่มคุยงาน',
            ...
            cancelJob: "ยกเลิกงาน",
            cancelJobMsg: "งานนี้ถูกยกเลิกแล้ว",
            reviewDeliveryTitle: "ตรวจสอบการส่งงาน",
            reviewDeliveryDesc: "ฟรีแลนซ์ได้ส่งงานแล้ว ต้องการยอมรับหรือขอแก้ไข?",
            acceptAndRelease: "ยอมรับและปล่อยเงิน",
        ...
        profileCoins: {
            ...
            labelYourCoin: "108Jobs Coin ของคุณ",
            noteBalanceUpdate:
                "ในบางกรณี อาจใช้เวลาสูงสุด 5 นาทีในการอัปเดตยอดเงิน กรุณารอสักครู่",
            noteCoinTerms:
                "• 108Jobs Coin สามารถใช้ได้โดยไม่มีวันหมดอายุ และสามารถใช้ร่วมกับคูปองบัญชีอื่นได้• 108Jobs Coin ไม่สามารถแลกเป็นเงินสดหรือโอนไปยังบัญชี 108Jobs อื่นได้• เมื่อคุณเติม 108Jobs Coin เข้าระบบ จะถือว่าคุณยอมรับข้อกำหนดและเงื่อนไข• หากคุณพบปัญหาในการเติมเงิน 108Jobs Coin หรือชำระเงิน กรุณาติดต่อศูนย์ช่วยเหลือ",
        ...
        profileCoupon: {
            ...
            subtitleDiscountsPromotions: "จากทาง 108Jobs และบริการที่เข้าร่วม",
            tabForFreelancers: "สำหรับฟรีแลนซ์",
            tabForHiring: "สำหรับการจ้างงาน",
        },
        profileData: {
            concent: "ยินยอมรับข่าวสารและโปรโมชั่นพิเศษผ่านทุกช่องทางจาก 108Jobs",
            privacy: "นโยบายความเป็นส่วนตัว",
            cookieUse:
                "108Jobs ใช้คุกกี้เพื่อช่วยปรับปรุงและเพิ่มประสบการณ์การใช้งานของคุณเมื่อคุณเข้าชมเว็บไซต์ของเรา คุณสามารถเลือกยินยอมคุกกี้แต่ละประเภทได้ (ยกเว้นคุกกี้ที่จำเป็น)",
            ...
            analyticsCookiesDescription:
                "ยินยอมให้ 108Jobs เก็บรวบรวมข้อมูลการใช้งานเพื่อนำมาวิเคราะห์ เพื่อปรับปรุงและพัฒนาประสบการณ์การใช้งานให้ดียิ่งขึ้น",
            cookiesManagement: "จัดการคุกกี้",
            dataManagement: "จัดการการใช้ข้อมูล",
            dataUsageFastwork: "การใช้ข้อมูลสำหรับ 108Jobs",
            functionalCookies: "คุกกี้ที่จำเป็นอย่างยิ่งในการใช้งาน",
            functionalCookiesDescription:
                "108Jobs จำเป็นต้องใช้คุกกี้ประเภทนี้ เพื่อให้คุณสามารถเข้าถึงข้อมูลและใช้งานหน้าฟังก์ชันบนเว็บไซต์ได้อย่างมีประสิทธิภาพ โดยคุกกี้นี้ไม่มีการจัดเก็บข้อมูลที่สามารถระบุตัวตนของผู้ใช้",
            mandatoryCookies:
                "คุกกี้เหล่านี้จำเป็นสำหรับการทำงานของเว็บไซต์และไม่สามารถปิดใช้งานได้",
            marketingCookies: "คุกกี้สำหรับการตลาดและโฆษณา",
            marketingCookiesDescription:
                "ยินยอมให้ 108Jobs เก็บรวบรวมข้อมูลสำหรับการทำโฆษณา เพื่อให้เราช่วยนำเสนอเนื้อหา บริการที่เหมาะสมกับคุณที่สุด",
            newsletterAccept: "ยินยอม",
            newsletterDecline: "ไม่ยินยอม",
            newsletterPromotions: "รับข่าวสาร ส่วนลดและโปรโมชั่นจาก 108Jobs",
        ...
        profileJob: {
            ...
            tableHeaderBudget: "งบประมาณ (บาท)",
        ...
        profilePoint: {
            ...
            faqBenefits: "สิทธิประโยชน์จากโปรแกรม 108Jobs rewards มีอะไรบ้าง?",
            faqBenefitsAnswer:
                "ตัวอย่างสิทธิประโยชน์จากโปรแกรม 108Jobs rewards: เงินคืน (Cashback) สำหรับฟรีแลนซ์ ส่วนลดพิเศษสำหรับใช้ในการจ้างงาน คูปองส่วนลดจากพาร์ทเนอร์ สิทธิพิเศษ ในการเข้าร่วมกิจกรรมต่างๆ ของ 108Jobs และอื่นๆ อีกมากมาย หมายเหตุ: สิทธิประโยชน์อาจมีการปรับเปลี่ยนตามช่วงเวลา เพื่อให้สอดคล้องกับความต้องการของผู้ใช้งาน",
            faqExpiration: "Point ในโปรแกรม 108Jobs rewards มีวันหมดอายุหรือไม่?",
            faqExpirationAnswer:
                "108Jobs Points มีอายุ 6 เดือน นับจากวันที่ได้รับ และจะหมดอายุสิ้นเดือนที่ 3 (ตัวอย่าง: หากได้รับ Points ในเดือนมกราคม จะหมดอายุวันที่ 30 เมษายน) เมื่อคุณแลกรางวัล ระบบจะใช้ Points ที่ใกล้หมดอายุก่อนโดยอัตโนมัติ",
            faqJoinRewards:
                "จะเข้าร่วมโปรแกรม 108Jobs rewards เพื่อรับสิทธิประโยชน์ได้อย่างไร?",
            faqJoinRewardsAnswer:
                "เพียงเข้าสู่ระบบ 108Jobs และไปที่หน้า 'ทำภารกิจ' เพื่อเริ่มสะสมคะแนน และแลกของรางวัลสุดพิเศษได้ทันที หากพบปัญหาในการเข้าใช้งาน กรุณาติดต่อศูนย์ช่วยเหลือของเรา",
            faqMorePoints: "อยากได้ Point เพิ่มใน 108Jobs rewards ต้องทำยังไงบ้าง?",
            faqMorePointsAnswer:
                "ทำกิจกรรมที่ระบุไว้ในหน้าภารกิจ เช่น เข้าสู่ระบบ และ check-in ในหน้า rewards เป็นประจำทุกวัน พิเศษสำหรับฟรีแลนซ์! รับงานผ่านระบบ 108Jobs ทุก 320 บาท จะได้รับ 1 point จากหน่วยที่ผู้ว่าจ้างอนุมัติ",
            filterAll: "ทั้งหมด",
            ...
            taskFirstPayment: "การชำระเงินครั้งแรกบน 108Jobs",
            ...
            terms3:
                "108Jobs ขอสงวนสิทธิ์ในการกำหนดและเปลี่ยนแปลงเงื่อนไขของโปรแกรมสะสมคะแนน รวมถึงการแลกรางวัลโดยไม่ต้องแจ้งให้ทราบล่วงหน้า",
        },
        proposal: {
        ...
        seller: {
            ...
            freelancerSetupSteps: "3 ขั้นตอนเพื่อสร้างรายได้บน 108Jobs",
            ...
            step2Desc:
                "สร้างบริการที่น่าสนใจเพื่อดึงดูดผู้ว่าจ้างและสร้างรายได้บน 108Jobs",
        ...
        sellerCommitmentLetter: {
            incomeTaxDescription:
                "เพื่อรับชำระเงินผ่านระบบของ 108Jobs ฟรีแลนซ์จะต้องยืนยันและยอมรับในการให้ข้อมูลรายได้ของตนเองเพื่อให้หน่วยงานภาษีตรวจสอบการปฏิบัติตามข้อกำหนดทางกฎหมาย",
            step1Note:
            ...
            step4Title: "ถ่ายรูปเอกสารและอัปโหลดผ่าน 108Jobs",
        ...
        supportCenter: {
            ...
            faqQuestion1: "วิธีจ้างฟรีแลนซ์ผ่าน 108Jobs?",
            faqQuestion1Step1:
            ...
            faqQuestion1Note:
                "หมายเหตุ: การชำระเงินที่ทำในระบบได้รับการคุ้มครองโดย 108Jobs ดูเพิ่มเติมที่ 108Jobs Guarantee",
            ...
            faqQuestion3Step1: "1. เพิ่ม @108jobs ผ่าน Line",
            ...
            addLineButton: "เพิ่ม @108jobs",
        },
        terms: {
            homepageTitle:
                "108Jobs - แพลตฟอร์มอันดับ 1 สำหรับฟรีแลนซ์คุณภาพที่ได้รับการเลือกจากธุรกิจทั่วประเทศไทย",
            homepageSubtitle: "จ้างฟรีแลนซ์บน 108Jobs",
            ...
            freelancerCategory3: "ผลงานตรงตามมาตรฐานขั้นพื้นฐานของ 108Jobs",
            freelancerCategoryCta: "ดูงานทั้งหมด",
            specialistCategoryTitle: "ผู้เชี่ยวชาญ 108Jobs",
            specialistCategory1: "มั่นใจในทักษะและบริการที่ผ่านการทดสอบ",
            specialistCategory2: "ยืนยันตัวตนในระบบ",
            specialistCategory3:
                "ได้รับการคัดเลือกและทดสอบความรู้และทักษะเฉพาะด้านโดย 108Jobs",
            specialistCategory4:
                "สำเร็จการฝึกอบรมพิเศษด้านทักษะและการให้บริการจาก 108Jobs",
            specialistCategory5: "มีใบรับรองวิชาชีพที่จำเป็นในสาขานั้น",
            professionalCategoryTitle: "ผู้เชี่ยวชาญระดับสูง 108Jobs",
            ...
            howToUseStep3Title: "ชำระเงินผ่าน 108Jobs",
            ...
            termsAndConditionsTitle:
                "ข้อกำหนดและเงื่อนไขการใช้แพลตฟอร์ม 108jobs.com สำหรับฟรีแลนซ์",
            section1Title: "คำนิยาม",
            definition1:
                "แพลตฟอร์มหมายถึงเว็บไซต์ (https://108jobs.com) และแอปพลิเคชัน 108Jobs",
            definition2:
            ...
            definition6: "บริษัทคือองค์กรที่บริหาร 108jobs.com",
            definition7: "108Jobs จัดหาแพลตฟอร์มสำหรับบริการจากบุคคลที่สาม",
            ...
            definition30: "108Jobs Coins คือคะแนนที่ลูกค้าสะสมหลังจากการชำระเงิน",
            ...
            section8Title: "108Jobs Coins และ Bonus Coins",
            coins1: "ลูกค้าเติม 108Jobs Coins เพื่อชำระค่าธรรมเนียม",
            coins2: "Coins ต้องใช้ภายใน 2 ปี",
            coins3: "Coins ที่ไม่ใช้เสียค่าธรรมเนียม 1 USD/เดือน",
            coins4: "การคืนเงิน Coins เสียค่าธรรมเนียมการทำธุรกรรม 1 USD",
            coins5: "Bonus Coins มอบให้เมื่อใช้งานตามเงื่อนไข",
            coins6: "Bonus Coins ต้องใช้ภายใน 1 ปี",
            ...
            privacyPolicy1:
                "อ่านนโยบายความเป็นส่วนตัวของเราที่ https://108jobs.com/seller-privacy",
            ...
            contact2: "ชื่อบริษัท: 108Jobs",
            contact3: "ที่อยู่: สำนักงานใหญ่ 108Jobs",
            contact4: "อีเมล: support@108jobs.com",
            contact5: "เว็บไซต์: https://static.108jobs.com/contents/support-center",
            ...
            termsTitle: "ข้อกำหนดและเงื่อนไขของ 108Jobs ",
            termsAcceptance:
                "ฉันได้อ่านและยอมรับข้อกำหนดและเงื่อนไขการใช้งานของ 108Jobs",
            privacyAcceptance: "ฉันได้อ่านและยอมรับนโยบายความเป็นส่วนตัว",
            marketingOptIn: "ฉันสนใจรับข้อมูล ข้อเสนอ และโปรโมชั่นจาก 108Jobs",
        ...
        termsEmployer: {
            ...
            definitionPlatform:
                "“แพลตฟอร์ม” หมายถึง เว็บไซต์ (https://108jobs.com/) หรือแอปพลิเคชั่น 108Jobs ของบริษัทฯ เป็นช่องทางและเป็นพื้นที่กลางที่เปิดให้ผู้ใช้งานสามารถสร้าง แบ่งปัน ขาย และซื้องานหรือบริการในรูปแบบของการชำระเงินตามมูลค่าที่ถูกกำหนดเอาไว้ของงานหรือบริการดังกล่าว",
            definitionWork:
            ...
            definitionFastworkCoin:
                "“เงินในระบบ (108Jobs Coin)” หมายถึง คะแนนที่ผู้ว่าจ้างเติมเข้าไปในบัญชีผู้ใช้งานเพื่อใช้ชำระค่าบริการ หรือค่าธรรมเนียมการชำระเงิน",
            definitionBonusCoin:
            ...
            "coinAndBonus.title": "108Jobs Coin และ Bonus Coin",
            "coinAndBonus.detail1":
                "ผู้ว่าจ้างมีสิทธิเติม 108Jobs Coin เข้าบัญชีผู้ใช้งานของตนเพื่อใช้ชำระค่าบริการหรือค่าธรรมเนียมการชำระเงินสำหรับงานใด ๆ ที่ใช้บริการผ่านแพลตฟอร์มได้ โดย 108Jobs Coin จะต้องถูกใช้ภายใน 2 ปี นับแต่วันที่เติม 108Jobs Coin ในกรณีที่ผู้ว่าจ้างไม่ใช้ 108Jobs Coin ภายใน 2 ปี นับจากวันที่เติม บริษัทฯ อาจเรียกเก็บค่าธรรมเนียมการรักษาสถานภาพของบัญชีผู้ใช้งานในอัตราเดือนละ 50 บาทได้ อย่างไรก็ดี ไม่ตัดสิทธิผู้ว่าจ้างที่จะขอให้บริษัทฯ โอน 108Jobs Coin ไปยังบัญชีธนาคารที่ผู้ว่าจ้างให้ข้อมูลสำหรับการคืน 108Jobs Coin ทั้งนี้ บริษัทฯ มีสิทธิเรียกเก็บค่าธรรมเนียมการดำเนินธุรกรรมคืน 108Jobs Coin ได้ในอัตรา 50 บาทต่อรายการ",
            ...
            "orderChange.method3":
                "กรณีผู้ว่าจ้างชำระค่าบริการด้วย 108Jobs Coin จะคืนค่าบริการดังกล่าวในรูปแบบของ 108Jobs Coin ผ่านบัญชีที่มีการชำระค่าบริการ",
            "orderChange.method4":
        ...
        jobApplication: {
            ...
            warningMessage: "คำเตือน: การชักชวนให้ลูกค้าชำระเงินนอกระบบ 108jobs ถือเป็นการฝ่าฝืนข้อกำหนดการใช้งานและอาจนำไปสู่การระงับบัญชี",
