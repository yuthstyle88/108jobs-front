...
export const th = {
    ...
    translation: {
        ...
        authen: {
            ...
            verificationMessage:
                `${getAppName()} จะทำการส่งรหัสยืนยันไปยัง อีเมล/เบอร์โทรศัพท์ของคุณ เพื่อยืนยันความเป็นเจ้าของบัญชี`,
        ...
        categoryFooter: {
            ...
            seoDescription2Part1:
                `คุณภาพ ช่วยให้เว็บไซต์ของคุณแสดงเป็นอันดับต้น ๆ บน Google ทำให้เว็บไซต์ของคุณมีโอกาสที่คนเข้าชมสูงขึ้นและเป็นที่รู้จักมากขึ้น ที่ ${getAppName()} เรามีฟรีแลนซ์ให้บริการ SEO ผู้เชี่ยวชาญที่มีประสบการณ์ในการ `,
            ...
            seoConclusionPart1:
                `รายละเอียดของการทำ SEO ไม่ได้มีตายตัว และเปลี่ยนแปลงบ่อย เพราะฉะนั้นต้องติดตามและคอยอัพเดตหลักการทำ SEO อยู่เสมอ ๆ หรือหากยังไม่มีประสบการณ์ ความรู้ ความชำนาญ สามารถจ้างฟรีแลนซ์ผู้เชี่ยวชาญรับทำ SEO ช่วยในการเริ่มต้น ให้คุณสำเร็จได้ง่ายกว่า ${getAppName()} ได้รวบรวม Freelance รับทำ SEO มืออาชีพด้วย `,
            ...
            howToHireSteps2:
                `ชำระเงินผ่าน ${getAppName()} โดยชำระได้ 3 ช่องทางทั้ง บัตรเครดิต, โมบายแบงค์กิ้ง และจ่ายด้วย ${getAppName()} coin มั่นใจได้แน่นอนด้วย ${getAppName()} การันตี`,
            howToHireSteps3:
        ...
        commission: {
            ...
            whatIsAccumulatedIncomeFeeDescription:
                `นี่คือค่าบริการที่ประกาศล่วงหน้าตามยอดรวมแต่ละครั้งสำหรับฟรีแลนเซอร์ โดยคำนวณตามระดับสมาชิก ${getAppName()} ระดับสมาชิกจะถูกกำหนดตามรายได้สะสมในช่วง 3 เดือนที่ผ่านมา ถึงวันที่สร้างรายงานโครงการและเสร็จสมบูรณ์`,
        ...
        employeeRegister: {
            ...
            fastworkUsageTip:
                `การใช้ ${getAppName()} อย่างถูกต้องช่วยลดความเสี่ยงในการถูกระงับบัญชี`,
            complianceTip:
        ...
        global: {
            ...
            businessServiceDescription:
                `บริการจัดหาฟรีแลนซ์เพื่อธุรกิจ (${getAppName()} for Business)`,
        ...
        guarantee: {
            ...
            fastworkGuaranteeSubtitle:
                `จ้างฟรีแลนซ์ผ่านแพลตฟอร์ม ${getAppName()} ได้รับการคุ้มครองอย่างครอบคลุมในทุกขั้นตอน`,
            fastworkGuaranteeSubsubtitle:
                "ตั้งแต่เริ่มต้นจนถึงส่งมอบงานที่มีคุณภาพตามที่ต้องการ",
            fastworkGuaranteeStepsTitle:
                `${getAppName()} Guarantee ปกป้องทุกขั้นตอนในกระบวนการจ้างงาน`,
            ...
            termsConditionsTitle:
                `ข้อกำหนดและเงื่อนไขของโปรแกรม ${getAppName()} Guarantee มั่นใจมากขึ้นในการจ้างงาน`,
            ...
            protectionCase4:
                `ผลงานสุดท้ายยังไม่ได้รับการอนุมัติด้วยตนเองหรืออัตโนมัติบนแพลตฟอร์ม ${getAppName()}`,
            endProtectionTitle: "สิ้นสุดการคุ้มครอง",
            endProtectionCase1: "ลูกค้าละเมิดสัญญาการจ้างงานที่ระบุในใบเสนอราคา",
            endProtectionCase2:
                `ลูกค้าไม่ได้ทำการจ้างงานและชำระเงินผ่านแพลตฟอร์ม ${getAppName()}`,
            endProtectionCase3:
                `ผลงานสุดท้ายได้รับการอนุมัติด้วยตนเองหรืออัตโนมัติบนแพลตฟอร์ม ${getAppName()}`,
            ...
            confidentHiringTitle:
                `มั่นใจในการจ้างงานกับ ${getAppName()} คุณมีอิสระในการเลือกที่จะยอมรับผลงานสุดท้ายหรือขอคืนเงิน`,
            ...
            step3Description:
                `แจ้งความคาดหวังของคุณเกี่ยวกับผลงานและคุณภาพบริการของฟรีแลนซ์ ไม่มีใครสามารถเข้าถึงการรีวิวแบบไม่เปิดเผยตัวตนนี้ได้ ยกเว้นบุคลากรหลักของ ${getAppName()} สิ่งนี้สำคัญอย่างยิ่งที่เราจะนำไปปรับปรุงคุณภาพฟรีแลนซ์ของเราเพื่อให้บริการคุณได้อย่างพึงพอใจที่สุด`,
            step4Title: `4. ให้คะแนนความประสงค์ในการแนะนำ ${getAppName()} ให้ผู้อื่น`,
            step4Description:
                `คุณสามารถแบ่งปันปัญหาหรือความยากลำบากที่คุณพบเจอในระหว่างการใช้แพลตฟอร์ม นอกจากนี้ คุณยังสามารถให้ความคิดเห็นและข้อเสนอแนะแก่ทีม ${getAppName()} ข้อเสนอแนะทั้งหมดของคุณจะได้รับการพิจารณาอย่างจริงจังเพื่อปรับปรุงคุณภาพบริการของเรา`,
        ...
        home: {
            ...
            contentQualityOfferFreelancerCard2:
                `ผ่านการตรวจสอบผลงาน ตามมาตรฐานขั้นต้นของ ${getAppName()}`,
            contentQualityOfferProfessionalCard1: "ผ่านการยืนยันตัวตนในระบบ",
            contentQualityOfferProfessionalCard2:
                `ผ่านการคัดเลือก ทดสอบความรู้ตามสายงาน และทักษะในการทำงานโดย ${getAppName()}`,
            contentQualityOfferProfessionalCard3:
                `ผ่านการอบรมพิเศษด้านทักษะและการให้บริการจาก ${getAppName()}`,
            ...
            contentQualityOfferSpecialistCard4:
                `มีใบประกอบวิชาชีพที่จำเป็นตามสายงาน ${getAppName()}`,
            ...
            titleTrustedCompanies:
                `กว่า 150,000 โปรเจกต์ที่สำเร็จ โดยบริษัทชั้นนำที่ไว้วางใจ ${getAppName()}`,
        ...
        how: {
            ...
            employerStep5List2:
                `แสดงความคิดเห็นเกี่ยวกับความพึงพอใจของคุณต่อระบบ ${getAppName()} เพื่อช่วยปรับปรุงคุณภาพบริการ`,
            sellerStep1Title:
                `ลงประกาศสินค้า/โปรเจกต์ของคุณบน ${getAppName()} เพื่อแสดงความสามารถพิเศษของคุณแก่ลูกค้าที่มีศักยภาพ`,
        ...
        jobBoardCreate: {
            ...
            warning:
                `คำเตือน: การชักชวนลูกค้าให้ชำระเงินนอกระบบ ${getAppName()} เป็นการละเมิดข้อกำหนดการใช้งานและอาจนำไปสู่การระงับบัญชีได้`,
        ...
        jobBoardDetail: {
            ...
            recommendation:
                `เราขอแนะนำให้คุณสื่อสารและชำระเงินผ่าน ${getAppName()} เพื่อป้องกันการฉ้อโกง! เราจะปกป้องการชำระเงินของคุณจนกว่าคุณจะได้รับผลงานจากฟรีแลนซ์`,
            wantToFind:
        ...
        manageProductCreate: {
            ...
            confirmationWarning:
                `หากคุณไม่ยืนยันเงื่อนไข คุณจะไม่สามารถเผยแพร่บริการบน ${getAppName()} ได้`,
            coverImageNote:
        ...
        profileApply: {
            ...
            careerGrowthDescription:
                `เข้าร่วมโปรแกรมทดสอบของ ${getAppName()} เพื่อเพิ่มความน่าเชื่อถือและความโดดเด่นบนระบบ`,
            ...
            freelancerProfessionalDescription:
                `ผู้เชี่ยวชาญหลายสาขาที่ผ่านการคัดเลือกจาก ${getAppName()}`,
            freelancerSpecialist: `${getAppName()} Specialist`,
            freelancerSpecialistDescription:
                `ผู้เชี่ยวชาญที่ผ่านการทดสอบความสามารถตามมาตรฐาน ${getAppName()}`,
            ...
            privilegesDescription:
                `ยิ่งขายงานมาก ยิ่งได้สิทธิพิเศษจาก ${getAppName()} มากขึ้น`,
            professional1: `ผู้เชี่ยวชาญหลายสาขาที่ผ่านการคัดเลือกจาก ${getAppName()}`,
            professional2: "ใช้สิทธิ์ขอคำปรึกษาโดยตรงผู้เชี่ยวชาญ",
            professional3:
                `Badge ที่แสดงสำหรับ Professional ผู้เชี่ยวชาญ ${getAppName()} ช่วยให้คุณจ้างงานที่คุณได้อย่างมั่นใจ`,
            professional4:
                `โอกาสในการได้รับงานมากยิ่งขึ้น จากลูกค้าองค์กรชั้นนำของ ${getAppName()}`,
            ...
            sellStep4Desc:
                `มั่นใจทุกการจ้างงานผ่าน ${getAppName()} การันตีดูแลเงินคุณ หมดกังวลเรื่องผู้ว่าจ้างไม่ชำระเงิน ช่วยให้คุณทำงานได้อย่างสบายใจ`,
            ...
            step6Description:
                `${getAppName()} โอนเงินเข้าบัญชีของคุณตามข้อตกลง ยิ่งขายมาก ยิ่งได้มาก`,
        ...
        profileChat: {
            ...
            sectionChat: "สนทนา",
            securePaymentNote: `ปลอดภัยว่า เชื่อจ่ายเงินผ่าน ${getAppName()}`,
        ...
        profileCoins: {
            ...
            labelYourCoin: `${getAppName()} Coin ของคุณ`,
            noteBalanceUpdate:
                "ในบางกรณี อาจใช้เวลาสูงสุด 5 นาทีในการอัปเดตยอดเงิน กรุณารอสักครู่",
            noteCoinTerms: `• ${getAppName()} Coin สามารถใช้ได้โดยไม่มีวันหมดอายุ และสามารถใช้ร่วมกับคูปองบัญชีอื่นได้• ${getAppName()} Coin ไม่สามารถแลกเป็นเงินสดหรือโอนไปยังบัญชี ${getAppName()} อื่นได้• เมื่อคุณเติม ${getAppName()} Coin เข้าระบบ จะถือว่าคุณยอมรับข้อกำหนดและเงื่อนไข• หากคุณพบปัญหาในการเติมเงิน ${getAppName()} Coin หรือชำระเงิน กรุณาติดต่อศูนย์ช่วยเหลือ`,
        ...
        profileData: {
            consent: `ยินยอมรับข่าวสารและโปรโมชันพิเศษจาก ${getAppName()} ผ่านทุกช่องทาง`, // formerly 'concent' fixed wording and key
            privacy: "นโยบายความเป็นส่วนตัว",
            cookieUse:
                `${getAppName()} ใช้คุกกี้เพื่อช่วยปรับปรุงและเพิ่มประสบการณ์การใช้งานของคุณเมื่อคุณเข้าชมเว็บไซต์ของเรา คุณสามารถเลือกยินยอมคุกกี้แต่ละประเภทได้ (ยกเว้นคุกกี้ที่จำเป็น)`,
            ...
            analyticsCookiesDescription:
                `ยินยอมให้ ${getAppName()} เก็บรวบรวมข้อมูลการใช้งานเพื่อนำมาวิเคราะห์ เพื่อปรับปรุงและพัฒนาประสบการณ์การใช้งานให้ดียิ่งขึ้น`,
            ...
            functionalCookiesDescription:
                `${getAppName()} จำเป็นต้องใช้คุกกี้ประเภทนี้ เพื่อให้คุณสามารถเข้าถึงข้อมูลและใช้งานหน้าฟังก์ชันบนเว็บไซต์ได้อย่างมีประสิทธิภาพ โดยคุกกี้นี้ไม่มีการจัดเก็บข้อมูลที่สามารถระบุตัวตนของผู้ใช้`,
            mandatoryCookies:
                "คุกกี้เหล่านี้จำเป็นสำหรับการทำงานของเว็บไซต์และไม่สามารถปิดใช้งานได้",
            marketingCookies: "คุกกี้สำหรับการตลาดและโฆษณา",
            marketingCookiesDescription:
                `ยินยอมให้ ${getAppName()} เก็บรวบรวมข้อมูลสำหรับการทำโฆษณา เพื่อให้เราช่วยนำเสนอเนื้อหา บริการที่เหมาะสมกับคุณที่สุด`,
        ...
        profilePoint: {
            ...
            terms3:
                `${getAppName()} ขอสงวนสิทธิ์ในการกำหนดและเปลี่ยนแปลงเงื่อนไขของโปรแกรมสะสมคะแนน รวมถึงการแลกรางวัลโดยไม่ต้องแจ้งให้ทราบล่วงหน้า`,
        },
        proposal: {
        ...
        supportCenter: {
            ...
            faqQuestion1Note:
                `หมายเหตุ: การชำระเงินที่ทำในระบบได้รับการคุ้มครองโดย ${getAppName()} ดูเพิ่มเติมที่ ${getAppName()} Guarantee`,
        ...
        terms: {
            homepageTitle:
                `${getAppName()} - แพลตฟอร์มอันดับ 1 สำหรับฟรีแลนซ์คุณภาพที่ได้รับการเลือกจากธุรกิจทั่วประเทศไทย`,
            ...
            specialistCategory3:
                `ได้รับการคัดเลือกและทดสอบความรู้และทักษะเฉพาะด้านโดย ${getAppName()}`,
            specialistCategory4:
                `สำเร็จการฝึกอบรมพิเศษด้านทักษะและการให้บริการจาก ${getAppName()}`,
            ...
            termsAndConditionsTitle: `ข้อกำหนดและเงื่อนไขการใช้แพลตฟอร์ม ${getAppName()} สำหรับฟรีแลนซ์`,
            section1Title: "คำนิยาม",
            definition1:
                "แพลตฟอร์มหมายถึงเว็บไซต์ (https://"+getAppName()+") และแอปพลิเคชัน ${getAppName()}",
            definition2:
            ...
            definition6: "บริษัทคือองค์กรที่บริหาร " + getAppName(),
            ...
            definition30: `${getAppName()} Coins คือคะแนนที่ลูกค้าสะสมหลังจากการชำระเงิน`,
            ...
            section8Title: `${getAppName()} Coins และ Bonus Coins`,
            ...
            privacyPolicy1: `อ่านนโยบายความเป็นส่วนตัวของเราที่ https://${getAppName()}/seller-privacy`,
            ...
            contact4: `อีเมล: support@${getAppName()}`,
            contact5: `เว็บไซต์: https://static.${getAppName()}/contents/support-center`,
        ...
        termsEmployer: {
            ...
            definitionPlatform:
                `“แพลตฟอร์ม” หมายถึง เว็บไซต์ (https://${getAppName()}/) หรือแอปพลิเคชั่น ${getAppName()} ของบริษัทฯ เป็นช่องทางและเป็นพื้นที่กลางที่เปิดให้ผู้ใช้งานสามารถสร้าง แบ่งปัน ขาย และซื้องานหรือบริการในรูปแบบของการชำระเงินตามมูลค่าที่ถูกกำหนดเอาไว้ของงานหรือบริการดังกล่าว`,
            definitionWork:
            ...
            definitionFastworkCoin: `“เงินในระบบ (${getAppName()} Coin)” หมายถึง คะแนนที่ผู้ว่าจ้างเติมเข้าไปในบัญชีผู้ใช้งานเพื่อใช้ชำระค่าบริการ หรือค่าธรรมเนียมการชำระเงิน`,
            definitionBonusCoin:
            ...
            "coinAndBonus.title": `${getAppName()} Coin และ Bonus Coin`,
            "coinAndBonus.detail1": `ผู้ว่าจ้างมีสิทธิเติม ${getAppName()} Coin เข้าบัญชีผู้ใช้งานของตนเพื่อใช้ชำระค่าบริการหรือค่าธรรมเนียมการชำระเงินสำหรับงานใด ๆ ที่ใช้บริการผ่านแพลตฟอร์มได้ โดย ${getAppName()} Coin จะต้องถูกใช้ภายใน 2 ปี นับแต่วันที่เติม ${getAppName()} Coin ในกรณีที่ผู้ว่าจ้างไม่ใช้ ${getAppName()} Coin ภายใน 2 ปี นับจากวันที่เติม บริษัทฯ อาจเรียกเก็บค่าธรรมเนียมการรักษาสถานภาพของบัญชีผู้ใช้งานในอัตราเดือนละ 50 บาทได้ อย่างไรก็ดี ไม่ตัดสิทธิผู้ว่าจ้างที่จะขอให้บริษัทฯ โอน ${getAppName()} Coin ไปยังบัญชีธนาคารที่ผู้ว่าจ้างให้ข้อมูลสำหรับการคืน ${getAppName()} Coin ทั้งนี้ บริษัทฯ มีสิทธิเรียกเก็บค่าธรรมเนียมการดำเนินธุรกรรมคืน ${getAppName()} Coin ได้ในอัตรา 50 บาทต่อรายการ`,
            ...
            "orderChange.method3": `กรณีผู้ว่าจ้างชำระค่าบริการด้วย ${getAppName()} Coin จะคืนค่าบริการดังกล่าวในรูปแบบของ ${getAppName()} Coin ผ่านบัญชีที่มีการชำระค่าบริการ`,
            "orderChange.method4":
            ...
            contactInfoCompanyName:
                "ชื่อบริษัทฯ บริษัท 108 พลาซ่า จำกัด",
            contactInfoAddress:
                "ที่อยู่ ",
            contactInfoEmail: "support@ibrowe.com",
            contactInfoPhone: "เบอร์โทรศัพท์ 02-114-7008",
            contactInfoWebsiteLinkText: `https://static.${getAppName()}/contents/support-center`,
        },
        userEdit: {
            addInfo: "เพิ่มข้อมูล",
