...
export const th = {
    ...
    translation: {
        ...
        categoryFooter: {
            ...
            howToHireSteps2: `ชำระเงินผ่าน ${getAppName()} โดยชำระได้ 3 ช่องทางทั้ง บัตรเครดิต, โมบายแบงค์กิ้ง และจ่ายด้วย ${getAppName()} coin มั่นใจได้แน่นอนด้วย ${getAppName()} การันตี`,
            howToHireSteps3:
