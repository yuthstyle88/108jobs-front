            ...
            <nav className="mx-4 sm:mx-6 lg:mx-8 flex flex-wrap items-center justify-between h-auto py-2">
                <section className="flex items-center gap-x-4 w-full sm:w-auto">
                    <div className="block md:hidden">
                        <LocaleLink prefetch={true} href="/" className="shrink-0">
                            <Image
                                src={AssetIcon.logo}
                                alt="logo"
                                className="w-16 h-16"
                ...
                <section className="flex items-center gap-4 w-full sm:w-auto mt-4 sm:mt-0 justify-end">
                    {!isLoggedIn && (
                        <LocaleLink prefetch={false} href="/job-board" className="text-white text-sm hover:text-gray-200">
                    ...
                    {!isLoggedIn && (
                        <>
                            <LocaleLink prefetch={false} href="/login" className="text-white text-sm hover:text-gray-200">
                                {t("global.labelSignInButton")}
                            </LocaleLink>
                            <LocaleLink prefetch={false} href="/register" className="text-white text-sm hover:text-gray-200">
