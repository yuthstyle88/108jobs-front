...
class RegisterFormClass extends Component<
  ...
  async handleRegisterSuccess(loginRes: LoginResponse, user: MyUserInfo) {
  ...
  setCaptchaAnswer = (value: string) => {
    ...
    this.props.formMethods.setValue("captchaAnswer",
      value);
  }
  handleCaptchaPlay = () => {
