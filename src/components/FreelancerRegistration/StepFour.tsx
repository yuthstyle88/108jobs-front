...
const StepFour: React.FC<StepFourProps> = ({ formData, updateFormData, nextStep, prevStep }) => {
  ...
  return (
    <div className="p-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-text_primary">อธิบายตัวตนของคุณให้ลูกค้ารู้จักมากขึ้น</h2>
        <p className="text-text_secondary mt-2">เล่าประวัติทางด้านอาชีพ เช่น ประสบการณ์การทำงาน ประวัติการศึกษา ใบรับรองที่เกี่ยวโยงฯ</p>
      </div>
        ...
        <div className="w-full md:w-1/2 md:pr-4 mb-6 md:mb-0">
          <div className="mb-4">
            ...
            <p className="text-xs text-text_secondary mt-2">
              ให้ข้อมูลประสบการณ์ทำงาน ทักษะที่โดดเด่น และสิ่งที่คุณสามารถทำได้ดี
            </p>
          </div>
        </div>
            ...
            <div className="p-6 bg-white">
              ...
              <div className="mt-4 bg-blue-50 p-4 rounded-lg border border-blue-100">
                <div className="flex">
                  ...
                  <div>
                    <p className="text-sm text-gray-700">{formData.bio || 'ยังไม่มีข้อมูล'}</p>
                  </div>
                </div>
              </div>
            </div>
