...
interface StepFiveProps {
  ...
  updateFormData: (data: { nationalIdFront?: string | null; nationalIdBack?: string | null }) => void;
  nextStep: () => void;
  prevStep: () => void;
}

const StepFive: React.FC<StepFiveProps> = ({ formData, updateFormData, nextStep, prevStep }) => {
  ...
  return (
    <div className="p-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-text_primary">ยืนยันตัวตนว่าคุณคือใคร</h2>
        <p className="text-text_secondary mt-2">อัพโหลดบัตรประชาชนเพื่อความปลอดภัยในการทำธุรกรรม</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="border border-gray-200 rounded-lg p-4">
          <h3 className="font-medium text-lg text-text_primary mb-4">รูปบัตรประชาชน</h3>
          <p className="text-sm text-text_secondary mb-4">ถ่ายให้เห็นด้านหน้าและสามารถอ่านข้อมูลบนบัตรประชาชนได้อย่างชัดเจน</p>
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <h3 className="font-medium text-lg text-text_primary mb-4">รูปบัตรประชาชน</h3>
          <p className="text-sm text-text_secondary mb-4">ถ่ายให้เห็นด้านหลังบัตร</p>
