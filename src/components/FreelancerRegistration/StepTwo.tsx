  ...
  return (
    <div className="p-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-text_primary">เลือกรูปที่บ่งบอกความเป็นคุณ</h2>
        <p className="text-text_secondary mt-2">การใช้ภาพหน้าชัดจะช่วยให้ลูกค้าเลือกคุณได้มากกว่าหรือใช้โลโก้ที่สื่อถึงของคุณเท่านั้น</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row">
            ...
            {formData.profileImage ? (
              ...
              >
                <div className="text-center">
                  ...
                  <span className="text-sm text-gray-500 mt-2 block">Upload Profile Image</span>
                </div>
              </div>
            )}
        ...
        <div className="w-full md:w-1/2">
          <div className="p-4 border border-gray-200 rounded-lg">
            <h3 className="font-medium text-lg text-text_primary mb-4">Profile Preview</h3>
