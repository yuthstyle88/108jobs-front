...
const JobCardSkeleton = () => {
  return (
    <div className="flex items-stretch w-full">
      <div className="relative grid grid-cols-2 [grid-template-areas:'cover_cover''content_content''footer-left_footer-right'] overflow-hidden w-full border  border-neutral-200 rounded-md bg-white">
