...
const GraphicDesign = () => {
  ...
  return (
    <div
      ...
      <Link prefetch={false} href={`/categories/${graphicDesignService.slug}`}
            className="px-2 text-[#485261] whitespace-nowrap sm:whitespace-normal">{graphicDesignService.name}</Link>
      <div
