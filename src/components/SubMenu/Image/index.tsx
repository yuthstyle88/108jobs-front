...
const ImageAndSound: React.FC = () => {
  ...
  return (
    <div
      ...
      <Link prefetch={false} href={`/categories/${imageAndSoundService.slug}`}
            className="px-2 text-[#485261] whitespace-nowrap sm:whitespace-normal">{imageAndSoundService.name}</Link>
      <div
