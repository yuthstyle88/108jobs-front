    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <select
            className="border text-textPrimary rounded-lg px-4 py-2 bg-white"
            defaultValue="2024"
          >
        ...
        <table className="min-w-[800px] divide-y divide-gray-200">
          <thead className="bg-[#F6F7F8]">
            <tr className="text-center">
              <th className="py-4 px-4 text-left font-medium text-textPrimary">
              ...
              <th className="py-4 px-4 text-center font-medium text-textPrimary">
                {data?.tableStatus}
              </th>
              <th className="py-4 px-4 text-left font-medium text-textPrimary"></th>
            </tr>
          </thead>
          <tbody>
            <tr className="hover:bg-gray-50 text-[14px] text-textPrimary font-sans">
