                        ...
                        actions.push(
                            <div key="insufficient"
                                ...
                                <div className="mt-1">
                                    ...
                                    <Link href="/coin"
                                          className="underline font-medium">{t('profileChat.topUpNow') || 'Top up now'}</Link>
                                </div>
                            </div>
                        );
                    }
