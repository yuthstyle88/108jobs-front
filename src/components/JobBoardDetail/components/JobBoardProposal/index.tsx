...
const JobBoardProposal = () => {
  return (
    <main className="mt-8 text-center text-[18px] text-textSecondary flex flex-col gap-4">
        ...
        <section className="grid grid-cols-[7fr_3fr] gap-4 ">
          <div className="grid gap-6">
            <div>
              <div className="flex flex-row items-center gap-[10px] ">
                ...
                />
                <p className="text-base font-normal text-textPrimary font-sans">
                  GiangCatluong
                </p>
              </div>
              <p className="text-start font-normal text-textPrimary font-sans mt-3 break-words whitespace-pre-wrap">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-start text-[16px] font-sans text-textPrimary">
                <strong>Portfolio URL</strong>
              </p>
              <Link prefetch={false} href="/">
                <p className="text-start text-textPrimary font-sans">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row justify-between items-center">
              ...
              <p className="text-start text-textPrimary font-sans">8 days</p>
            </div>
          </div>
        </section>
      </div>
